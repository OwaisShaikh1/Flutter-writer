...
class SyncLogDao extends DatabaseAccessor<AppDatabase> with _$SyncLogDaoMixin {
  ...
  Future<void> logItemCreate(int localId, Map<String, dynamic> data) async {
  ...
  Future<void> logChapterCreate(int chapterId, int itemId, Map<String, dynamic> data) async {
    await into(syncLog).insert(SyncLogCompanion(
  ...
  Future<void> logChapterUpdate(int chapterId, int itemId, Map<String, dynamic> data) async {
